...
<head>
  ...
  <title>CRUD-Object-Oriented PHP-(PDO)</title>
<style>
body {font-family: arial;font-size: 15px;line-height: 18px;margin: 0 auto;width: 1024px;}
a{color:#3399FF;}
.headeroption {background: #3399ff; height: 80px;overflow: hidden;padding-left: 160px;}
...
.mainright{float:right;width:65%;}
...
<body>
  <header class="headeroption">
    <h2>CRUD-Object-Oriented PHP-(PDO)</h2>
  </header>
<div class="content">
